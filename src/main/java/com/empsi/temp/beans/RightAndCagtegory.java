...
public class RightAndCagtegory {
	...
	public RightAndCagtegory() {
		...
		gestionFormation.put("l'affectation des matieres aux enseignants", "#affectationMatieresEnsP");
		...
		categories.put("gestion des inscription", gestionInscription);
		...
		categories.put("Gestion de patrimoine", gestionPatrimoine);
